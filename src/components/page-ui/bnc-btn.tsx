...
export const BinanceBtn = () => {
  ...
  return (
    <Link href={url}>
      <Button className='flex w-fit select-none items-center justify-center gap-2 rounded bg-amber-400 hover:bg-amber-500/90'>
        شراء الرصيد من <span className='font-roboto'>Binance</span>
        <svg
