export const ServiceSection = () => {
    ...
    return (
        <div className="w-full mt-5 flex flex-col gap-3 justify-center items-center max-w-6xl">
            <div className="flex flex-col gap-2 justify-center items-center">
                <h2 className="text-2xl font-bold text-primary">خدماتنا</h2>
                <p className="text-center text-slate-400">نقدم لكم أفضل الخدمات وبأمان تام.</p>
            </div>
            <div className="w-full mt-10 grid grid-cols-1 md:grid-cols-3 max-w-7xl gap-3">
                {data.map((item, index) => (
                    <div
                        key={index}
                        className="flex gap-1 justify-center items-center">
                        <div className="size-14 bg-slate-100 justify-center items-center flex rounded-sm text-primary">
                        ...
                        <div className="flex flex-col  items-start justify-start">
                            ...
                            <p className="text-center text-slate-400">{item.description}</p>
                        </div>
                    </div>
                ))}
            </div>
