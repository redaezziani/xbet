...
const Footer = () => {
  ...
  return (
    <footer className='w-full bg-white mt-5 border-t border-slate-200'>
      <div className='mx-auto max-w-6xl px-6 py-10 lg:px-8'>
        <div className='mb-10 grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5'>
          ...
          <div>
            <h4 className='text-xs font-semibold uppercase text-gray-900'>المنتج</h4>
            <ul className='mt-3 space-y-3 text-sm'>
              {productLinks.map((link, index) => (
                <li key={index}>
                  <Link href={link.href}>
                    <p className='text-gray-600 hover:text-gray-800'>{link.title}</p>
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <div>
            <h4 className='text-xs font-semibold uppercase text-gray-900'>الشركة</h4>
            <ul className='mt-3 space-y-3 text-sm'>
          ...
          <div>
            <h4 className='text-xs font-semibold uppercase text-gray-900'>الموارد</h4>
            <ul className='mt-3 space-y-3 text-sm'>
          ...
          <div>
            <h4 className='text-xs font-semibold uppercase text-gray-900'>المطورين</h4>
            <ul className='mt-3 space-y-3 text-sm'>
            ...
            <h4 className='mt-7 text-xs font-semibold uppercase text-gray-900'>الصناعات</h4>
            <ul className='mt-3 space-y-3 text-sm'>
          ...
          <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between'>
            ...
            <div className='mt-5 flex space-x-4 sm:mt-0 sm:justify-end'>
              <div className='text-gray-400 hover:text-gray-500'>
                ...
                className="flex text-green-500 gap-1 justify-center items-center">
