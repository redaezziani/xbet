        ...
        <div className='mt-24 md:hidden w-full flex max-w-6xl flex-col items-center justify-center gap-0'>
            <div
                ...
                {imagesSlideOne.map((logo, index) => (
                    <img key={index} src={logo} className={` aspect-auto h-6 md:h-10  item-phone-slide-1 item-phone-s1-${index + 1} absolute `} />
                ))}
            </div>
            ...
            <div
                ...
                {imagesSlideTwo.map((logo, index) => (
                    <img key={index} src={logo} className={` aspect-auto h-6 md:h-10  item-phone-slide-2 item-phone-s2-${index + 1} absolute `} />
                ))}
            </div>
